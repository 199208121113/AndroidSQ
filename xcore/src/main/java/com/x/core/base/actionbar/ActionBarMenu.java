package com.x.core.base.actionbar;
...
public class ActionBarMenu implements OnClickListener {
	...
	public void setViewAndListener(View v, OnActionBarItemSelectedListener listener) {
		...
		leftExtraLayout = (LinearLayout) viewGroup.findViewById(R.id.action_bar_left_extra_layout);
		borderView = (TextView) viewGroup.findViewById(R.id.action_bar_border);
		if (this.getIcon() > 0) {
