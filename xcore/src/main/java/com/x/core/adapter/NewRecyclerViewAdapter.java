 ...
 */
public abstract class NewRecyclerViewAdapter<VH extends NewRecyclerViewHolder> extends RecyclerView.Adapter<VH> {
    @SuppressWarnings("unused")
    private static final String TAG = NewRecyclerViewAdapter.class.getSimpleName();
    private Context ctx;
    protected LayoutInflater inflater;
    private ArrayList<NewAdapterItem> mDataList = new ArrayList<>();
    ...
    public NewRecyclerViewAdapter(Context ctx) {
        this.ctx = ctx;
    ...
    public final VH onCreateViewHolder(ViewGroup parent, int viewType) {
        try {
            ...
            LogUtil.e(TAG,"onCreateViewHolder(),err="+ ExceptionUtil.getStackTrace(e));
            throw e;
        }
    }
    ...
    public final NewAdapterItem getItem(int location){
